...
| Avoid executing model output | Don't run generated scripts; **do not copy-paste directly into audit tools** (e.g., Drata/Vanta) without manual validation | **LLM05:2025 Improper Output Handling** | Model output is untrusted input to your systems and audit records; manual validation prevents incorrect control mappings from entering compliance platforms. |
